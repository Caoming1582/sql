...
Your thoughts...
```
This article illustrates an important point that datbases don't just store reality but they also decide what counts as reality. Similarly, in academia data such as h-index tools can quietly define who looks sucessful. The embedded values include the quantity of publication, timeline and authorship. However, these metric also have signficant drawn backs. For instance, teaching heavy academics might not publish as many research articles and can appear as less productive. Furthermore, collaborative lab cultures can translate unevenly into measurable credit. Thus, the evaluation system can privilege certain career paths while making of form of contribution less visible such as teaching, mentorship and service. This article reminds me that database systems are not neutral but shaped by institutional values. This is an important realization because it helps us to question how evaluation systems can be redesigned to better reflect the diverse forms of contribution within academia. 